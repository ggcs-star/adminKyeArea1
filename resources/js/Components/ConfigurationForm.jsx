...
const ConfigurationForm = ({ closeModal, configData }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const payload = { project_id: form.project_id, type: form.type, configuration, type_price: form.type_price };
        if (configData) {
                            ...
                            filteredProjects.map(project => (
                                <div
                                    ...
                                    className={`px-3 py-2.5 cursor-pointer hover:bg-blue-50 ${
                                        form.project_id === project.id ? "bg-blue-100 text-blue-700" : "text-gray-700"
                                    }`}
                                >
                                    {project.name}
                                </div>
