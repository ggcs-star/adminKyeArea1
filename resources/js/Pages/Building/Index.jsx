...
const BuildingPage = ({ auth, projects, allProjects }) => {
    ...
    const handleDelete = (projectId) => {
        if (confirm("Are you sure you want to delete this building info?")) {
            Inertia.delete(`/projects/${projectId}/building`, {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                        <div className="mb-4 sm:mb-0">
                            <h1 className="text-3xl font-bold text-gray-900">Project Building Information</h1>
                            <p className="text-gray-600 mt-2">Manage building details and specifications for all projects</p>
                        </div>
                                            ...
                                            <tr key={proj.id} className="hover:bg-gray-50 transition-colors duration-150">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center">
                                                        {proj.building?.entry_direction ? (
                                                            <>
                                                                <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                                </svg>
                                                                <span className="text-sm text-gray-700">Entry: {proj.building.entry_direction}</span>
                                                            </>
                                                        ) : (
                                                            <span className="text-sm text-gray-400 italic">No building info</span>
                                                        )}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center space-x-2">
                                                        <button
                                                            onClick={() => Inertia.get(`/projects/${proj.id}/building`)}
                                        ...
                                        <tr>
                                            <td colSpan="4" className="px-6 py-12 text-center">
                                                <div className="flex flex-col items-center justify-center text-gray-400">
                                                    ...
                                                    <p className="text-lg font-medium text-gray-500">No building information found</p>
                                                    <p className="text-sm text-gray-400 mt-1">Get started by creating your first building information</p>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
